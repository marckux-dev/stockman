...
public class ChangePasswordTest extends BaseTest {
  ...
  void shouldSetPasswordUsingValidToken() {
    ...
    changePassword.execute(new ChangePasswordCommand(token, newPassword));
  ...
  void shouldRejectExpiredToken() {
    ...
    assertThrows(InvalidTokenException.class, () -> changePassword.execute(new ChangePasswordCommand(token, "NewPass1")));
  ...
  void shouldFailWhenTokenNotFound() {
    ...
    assertThrows(ResourceNotFoundException.class, () -> changePassword.execute(new ChangePasswordCommand(token, "NewPass1")));
    verify(userRepository, never()).save(any(User.class));
  }
}
