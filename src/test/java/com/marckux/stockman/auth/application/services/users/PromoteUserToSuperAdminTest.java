...
public class PromoteUserToSuperAdminTest extends BaseTest {

  @Mock
  private UserRepositoryPort userRepository;

  @InjectMocks
  private PromoteUserToSuperAdmin service;

  @Test
  @DisplayName("Promueve USER a SUPER_ADMIN")
  void shouldPromoteUserToSuperAdmin() {
    ...
    assertEquals(Role.SUPER_ADMIN.name(), result.role());
  }
