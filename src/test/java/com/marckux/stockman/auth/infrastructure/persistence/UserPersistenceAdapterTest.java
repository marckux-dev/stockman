...
class UserPersistenceAdapterTest extends BaseTest {
    ...
    void shouldMapDomainToEntity() {
        ...
        // THEN
        // Verificamos que al repositorio JPA le llegó la entidad con los datos crudos extraídos de los VOs
        verify(jpaUserRepository).save(org.mockito.ArgumentMatchers.argThat(entity -> 
